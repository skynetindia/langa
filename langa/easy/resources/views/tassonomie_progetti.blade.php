...
<div class="table-responsive">
	...
	@foreach($statiemotiviprogetti as $statoemotivotipo)
		...
		<form action="{{url('/admin/tassonomie/aggiornastatiprogetti')}}" method="post">
		...
		<div class="form-group">
                ...
                <div class="col-xs-6 col-sm-3">
                    ...
                    <div class="col-xs-6 col-sm-3">
                        ...
                        <a  onclick="conferma(event);" type="submit" href="{{ url('/admin/tassonomie/statiprogetti/delete/id' . '/' . $statoemotivotipo->id)}}" class="btn danger">
