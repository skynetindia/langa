...
<h1>Aggiungi nuova disposizione</h1><hr>
...
<form action="{{url('/pagamenti/tranche/store')}}" method="post">
	{{ csrf_field() }}
<div class="row">
	<div class="col-md-8">
    	    <script>
	...
	<input type="hidden" name="id_disposizione" value="{{$idfattura}}">
        ...
        <input value="{{old('idfattura')}}" type="text" id="id" name="idfattura" placeholder="Codice del pagamento" class="form-control"><br>
	...
	<label for="Tipo">Tipo di fattura</label>
	    ...
	    <script>
	   	...
	   	<br><table class="table table-bordered">
	   		...
	   		<tbody>
	   			<td><input id="peso" class="form-control" type="text" name="peso" value="{{old('peso')}}"></td>
