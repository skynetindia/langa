    ...
    link.dispatchEvent(clickEvent);
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4"><label for="emissione">Emissione del</label>
                    <input type="text" name="emissione" id="emissione" class="form-control" value="{{$tranche->emissione}}"><br></div>
                <div class="col-md-4">
...
<!--                <th>% Sconto</th>
                ...
                <tbody id="corpofattura">
                    @if($corpofattura)
                    @foreach($corpofattura as $corpo)
                    <tr>
                        <td><input type="checkbox" class="selezione"></td>
                        <td><input type="text" value="{{$corpo->ordine}}" class="form-control" name="ordine[]" >
                        <input type="text" value="{{$corpo->ordino_quote}}" class="form-control" name="ordine1[]" ></td>
                        <td><textarea class="form-control" name="desc[]">{{$corpo->descrizione}}</textarea></td>
                        <td><input type="text" class="form-control" value="{{$corpo->qta}}" name="qt[]"></td>
                        <td><input type="text" class="form-control" value="{{$corpo->subtotale}}" name="subtotale[]"></td>
                        <td><input type="text" class="form-control" value="{{$corpo->totale}}" name="totale[]"></td>
                    </tr>
                    @endforeach
                    @endif
                ...
                <script>
                    ...
                    $j('#aggiungiCorpo').on("click", function () {
                        ...
                        var ord1 = $("#project_id").val()+":"+$("#year").val();
                        var ord2 = $("#quote_id").val()+":"+$("#year").val();;
...
<!--	   	<td><input id="peso" class="form-control" type="text" name="peso" value="{{$tranche->peso}}"></td>-->
                    ...
                    <td><input id="nettototal" class="form-control" type="text" name="nettototal" value="{{$tranche->nettototal}}"></td>
        ...
        <div class="col-md-4">
            ...
            <label for="privato">Nascondi statistiche <i class="fa fa-eye-slash" title="Se sì, questa disposizione non influenzerà le statistiche economiche"></i>
                ...
                <select name="tipo" id="tipo" class="form-control">
                    ...
                    <option  selected value="2">Performa</option>
                    @elseif($tranche->tipo == 1)
                    <option value="0">Pagamento</option>
...
?>
{{ csrf_field() }}
<input type="hidden" name="idutente" value="{{$tranche->user_id}}">
<input type="hidden" name="mediaCode" id="mediaCode" value="{{$mediaCode}}" />

</form>

<input type="hidden" name="year" id="year"  value="{{date("y", strtotime($progetti[0]->datainizio))}}">
<input type="hidden" name="quote_id" id="quote_id"  value="{{$progetti[0]->id_preventivo}}">
<input type="hidden" name="project_id" id="project_id"  value="{{$progetti[0]->id}}">
