...
<input type="hidden" name="mediaCode" id="mediaCode" value="{{$mediaCode}}" />
        ...
        <input value="" type="text" id="name_preventivo" name="name_preventivo" placeholder="name preventivo" class="form-control"><br>
        <div class="row">
                <div class="col-md-4">
    ...
    <script>
        ...
        $('#add').on("click", function() {
          ...
          //  codiceInput.value = Math.random().toString(36).substring(7);
            ...
            radio1_optional.name = "cicli1_optional";
            radio2_optional.name = "cicli2_optional";
            radio3_optional.name = "cicli3_optional";
            radio4_optional.name = "cicli4_optional";
            radio5_optional.name = "cicli5_optional";
