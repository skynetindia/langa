...
<form action="{{ url('/preventivi/add') }}" method="post" style="display:inline;">
    {{ csrf_field() }}
...
<button class="button button2" type="button" name="miei" title="Miei - Filtra i tuoi preventivi" style="background-color:#337AB7;color:#ffffff">Miei</button>
</a>
<a id="tutti" href="{{url('/preventivi')}}" style="display:inline;">
<button class="button button3" type="button" name="tutti" title="Tutti - Mostra tutti i preventivi">Tutti</button>
</a>
@else
<a id="miei" href="{{url('/preventivi/miei')}}" style="display:inline;">
<button class="button button2" type="button" name="miei" title="Miei - Filtra i tuoi preventivi">Miei</button>
</a>
<a id="tutti" href="{{url('/preventivi')}}" style="display:inline;">
<button class="button button3" type="button" name="tutti" title="Tutti - Mostra tutti i preventivi" style="background-color:#D9534F;color:#ffffff">Tutti</button>
</a>
@endif
...
<br><br>
    ...
    <table data-toggle="table" data-search="true" data-pagination="true" data-id-field="id" data-show-refresh="true" data-show-columns="true" data-url="<?php if(isset($miei)) echo url('preventivi/miei/json'); else echo url('/preventivi/json');?>" data-classes="table table-bordered" id="table">
        <thead>
            ...
            <th data-field="data" data-sortable="true">Data esecuzione
            <th data-field="valenza" data-sortable="true">Data scadenza
