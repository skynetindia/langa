...
<h1>Tassonomie preventivi</h1><hr>
...
<div class="table-responsive">
	...
	@foreach($statiemotiviprogetti as $statoemotivotipo)
		...
		<form action="{{url('/admin/tassonomie/aggiornastatipreventivi')}}" method="post">
		...
		<div class="form-group">
                ...
                <div class="col-xs-6 col-sm-3">
                    ...
                    <div class="col-xs-6 col-sm-3">
                        ...
                        <a  onclick="conferma(event);" type="submit" href="{{url('/admin/tassonomie/statipreventivi/delete/id' . '/' . $statoemotivotipo->id)}}" class="btn danger"><button type="button" class="btn btn-danger">Cancella</button></a></td>
                    </div>	
				</div>
			</form>
		</tr>
