...
<button class="btn btn-primary" type="button" name="update" title="Chiedi di modificare l'ultimo progetto selezionato"><span class="fa fa-pencil"></span></button>
    ...
    <table data-toggle="table" data-search="true" data-pagination="true" data-id-field="id" data-show-refresh="true" data-show-columns="true" data-url="progetti/json" data-classes="table table-bordered" id="table">
        <thead>
...
function multipleAction(act) {
	...
	switch(act) {
			case 'modify':
                if(n!=0) {
					n--;
					link.href = "{{ url('/richiedimodifica/progetto') }}" + '/' + indici[n];
					n = 0;
					selezione = undefined;
