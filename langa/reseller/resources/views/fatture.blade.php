...
<button class="btn btn-primary" type="button" name="update" title="Chiedi di modificare l'ultima fattura selezionata"><span class="fa fa-pencil"></span></button>
...
<button class="btn" type="button" name="pdf" title="PDF - Generale il PDF delle fatture selezionate"><span class="fa fa-file-pdf-o"></span></button>
    ...
    <table data-toggle="table" data-search="true" data-pagination="true" data-id-field="id" data-show-refresh="true" data-show-columns="true" data-url="fatture/json" data-classes="table table-bordered" id="table">
        <thead>
...
function multipleAction(act) {
	...
	switch(act) {
			case 'modify':
                if(n!=0) {
					n--;
					link.href = "{{ url('/richiedimodifica/fattura') }}" + '/' + indici[n];
					n = 0;
					selezione = undefined;
