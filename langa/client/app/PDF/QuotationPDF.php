...
// 		var_dump($this -> h);
	...
	function Footer()
	{
		...
		$this->SetX(88);
		$this->SetFontSize(3.8);
		$x = $this->GetX();
		$y = $this->GetY();
		$this->MultiCell(100, 3, "IL MATERIALE LANGA E' PROTETTO DA COPYRIGHT LANGA WEB INFORMATICA. FIRMANDO QUESTO DOCUMENTO SI ACCETTA/AUTORIZZA LANGA WEB INFORMATICA AD INIZIARE I PROCESSI TECNICI/AMMINISTRATIVI/COMMERCIALI APPLICANDO I METODI DI LAVORO LANGA. INFO SU www.langa.tv", self::BORDER4DEV, "C");
		$this->SetY($y);
		$this->SetX($x+100);
		$this->SetFontSize(10);
