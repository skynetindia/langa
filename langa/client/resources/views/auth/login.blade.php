    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Login Easy Client LANGA</div>
                <div style="text-align:center" class="col-md-4">
                        <br><p align="center"><a href="http://www.easy.langa.tv/"><img style="width:200px;height:200px;padding-top:15px" src="{{url('images/Easy CLIENT.png')}}" onmouseover="this.src='{{url('images/logo.png')}}'" onmouseout="this.src='{{url('images/Easy CLIENT.png')}}'" /></a></p>  
                </div>
